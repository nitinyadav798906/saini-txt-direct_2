...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/+zU2qSJ_kKgZiMDIx")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/Rafttar_don"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+zU2qSJ_kKgZiMDIx"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using 𝙎achin nitin yadav:\n\n"
        ...
        f"**If you have any questions, feel free to ask [𝙎achin nitin yadav🇮🇳](https://t.me/+zU2qSJ_kKgZiMDIx)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[𝙎achin nitin yadav](https://t.me/+zU2qSJ_kKgZiMDIx)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                               ...
                               f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝙎achin nitin yadav](https://t.me/+zU2qSJ_kKgZiMDIx)"
